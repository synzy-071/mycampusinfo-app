...
class HostelViewModel extends ChangeNotifier {
  final HostelDataSource _dataSource;

  HostelViewModel(this._dataSource);
  ...
  Future<void> getHostelsByCollegeId({
    ...
    final result =
        await _dataSource.getHostelsByCollegeId(collegeId: collegeId);
