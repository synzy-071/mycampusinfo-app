...
class _HostelViewState extends State<HostelView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context
          .read<HostelViewModel>()
          .getHostelsByCollegeId(collegeId: widget.collegeId);
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<HostelViewModel>(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _infoRow(
                        'AC Available', hostel.acAvailable ? 'Yes' : 'No'),
                    _infoRow(
                        'Mess Available', hostel.messAvailable ? 'Yes' : 'No'),
